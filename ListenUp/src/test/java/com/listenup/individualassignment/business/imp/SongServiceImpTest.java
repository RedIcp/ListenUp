...
import com.listenup.individualassignment.business.dtoconverter.*;
...
class SongServiceImpTest {
    ...
    @Mock
    private SongListDTOConverter songList;
    ...
    void getSongs() {
        ...
        expectedList.add(songList.convertToSingleSongDTO(song1));
        expectedList.add(songList.convertToSingleSongDTO(song2));
