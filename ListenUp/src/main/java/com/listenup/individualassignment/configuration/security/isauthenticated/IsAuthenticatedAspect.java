package com.listenup.individualassignment.configuration.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(com.listenup.individualassignment.configuration.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(com.listenup.individualassignment.configuration.security.isauthenticated.IsAuthenticated)")
